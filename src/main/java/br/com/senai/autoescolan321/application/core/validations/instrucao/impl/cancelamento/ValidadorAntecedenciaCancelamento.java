...
public class ValidadorAntecedenciaCancelamento implements ValidadoresCancelamento {
    ...
    public ValidadorAntecedenciaCancelamento(InstrucaoJpaRepository instrucaoJpaRepository) {
        this.instrucaoJpaRepository = instrucaoJpaRepository;
    }

    @Override
    public void validar(DadosCancelamentoInstrucao dados) {
        LocalDateTime dataAgendamento = instrucaoJpaRepository.findById(dados.id())
